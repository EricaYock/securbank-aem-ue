...
export default async function decorate(block) {
  ...
  const url = `https://author-p134711-e1334063.adobeaemcloud.com/graphql/execute.json/securbank/FAQListbyTag;tag=${firsttag};variation=${variationname}?ts=${cachebuster}`;
  const options = {};
